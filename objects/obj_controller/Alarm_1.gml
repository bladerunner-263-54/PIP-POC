...
if(reset_turn == 1)
{
	...
	if(global.moves_available <= 0)
	{
		...
		// level.
		layer_sequence_create("UIElements1", room_width / 2, (room_height / 2) - 200, seq_fim_de_jogo);
	}
	...
	else
	{
		...
		else
		{
			...
			layer_sequence_create("UIElements1", room_width / 2, (room_height / 2) - 200, seq_no_matches)
