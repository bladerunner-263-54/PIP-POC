...
if(type_0 != -1)
{
	...
	draw_sprite(spr_objective_tokens, type_0, x + 100, y + _y_offset);
...
if(type_1 != -1)
{
	...
	draw_sprite(spr_objective_tokens, type_1, x + 100, y + _y_offset);
...
if(type_2 != -1)
{
	...
	draw_sprite(spr_objective_tokens, type_2, x + 100, y + _y_offset);
...
draw_sprite_ext(spr_moves_icon, 0, x + 160, y + 685, 0.8, 0.8, 0, c_white, 1);
...
draw_text(x + 230, y + 690,  + string(global.moves_available));